...
INSERT INTO documents 
	(title, description, category_id, release_year, price, created_at, updated_at, deleted_at, is_flag, "data", tag)
SELECT title, description, category_id, release_year, price, created_at, updated_at, deleted_at, is_flag, "data", tag FROM documents1 LIMIT 10000000;
...
UPDATE documents SET tag = 'дом';
UPDATE documents SET is_flag = true;
UPDATE documents SET created_at = now(), updated_at = now(), deleted_at = NULL WHERE id BETWEEN 3 AND 10;

SELECT * FROM documents ORDER BY updated_at DESC LIMIT 10;
SELECT * FROM documents ORDER BY id ASC LIMIT 10;
SELECT * FROM documents WHERE title LIKE '% мой дом %' LIMIT 10;
...
CREATE TABLE public.documents (
	...
	"data" jsonb NULL,
	tag text NULL,
	CONSTRAINT documents_pk_2 PRIMARY KEY (id)
);
