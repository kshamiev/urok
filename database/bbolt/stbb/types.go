...
// Для проверки на получение несуществующего объекта

var ErrNotFound = errors.New("Не найдено")

// Все типы работающие с БД ... должны реализовывать данный интерфейс
// В остальном никаких ограничений нет. Тип может содержать любое количество свойств любого типа.
// Идентификаторы также могут быть любого типа.
// В методах интерфейса необходимо реализовать их представление в срез байтов для БД и наоборот
...
// Все типы работающие массивами данных должны реализовывать данный интерфейс
