...
type Order struct {
	...
	UsersID null.Bytes  `boil:"users_id" json:"users_id,omitempty" toml:"users_id" yaml:"users_id,omitempty"`
...
var OrderWhere = struct {
	...
	UsersID whereHelpernull_Bytes
}{
	ID:      whereHelpertypes_UUID{field: "`orders`.`id`"},
	Name:    whereHelpernull_String{field: "`orders`.`name`"},
	UsersID: whereHelpernull_Bytes{field: "`orders`.`users_id`"},
}
...
var (
	orderAllColumns            = []string{"id", "name", "users_id"}
	orderColumnsWithoutDefault = []string{"id", "name", "users_id"}
...
func (q orderQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Order, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "most: failed to execute a one query for orders")
	}
...
func (q orderQuery) All(ctx context.Context, exec boil.ContextExecutor) (OrderSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "most: failed to assign all query results to Order slice")
	}
...
func (q orderQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "most: failed to count orders rows")
	}
...
func (q orderQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "most: failed to check if orders exists")
	}
...
func FindOrder(ctx context.Context, exec boil.ContextExecutor, iD types.UUID, selectCols ...string) (*Order, error) {
	orderObj := &Order{}
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "most: unable to select from orders")
	}
...
func (o *Order) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("most: no orders provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "most: unable to insert into orders")
	}
	...
	if err != nil {
		return errors.Wrap(err, "most: unable to populate default values for orders")
	}
...
func (o *Order) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("most: unable to update orders, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "most: unable to update orders row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "most: failed to get rows affected by update for orders")
	}
...
func (q orderQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "most: unable to update all for orders")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "most: unable to retrieve rows affected for orders")
	}
...
func (o OrderSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "most: unable to update all in order slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "most: unable to retrieve rows affected all in update all order")
	}
	return rowsAff, nil
}
...
func (o *Order) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("most: no orders provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("most: unable to upsert orders, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "most: unable to upsert for orders")
	}
	...
	if err != nil {
		return errors.Wrap(err, "most: unable to retrieve unique values for orders")
	}
...
func (o *Order) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("most: no Order provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "most: unable to delete from orders")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "most: failed to get rows affected by delete for orders")
	}
...
func (q orderQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("most: no orderQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "most: unable to delete all from orders")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "most: failed to get rows affected by deleteall for orders")
	}
...
func (o OrderSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "most: unable to delete all from order slice")
	}
...
func (o *OrderSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "most: unable to reload all in OrderSlice")
	}
...
func OrderExists(ctx context.Context, exec boil.ContextExecutor, iD types.UUID) (bool, error) {
	var exists bool
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "most: unable to check if orders exists")
	}
