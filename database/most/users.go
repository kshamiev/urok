...
var UserWhere = struct {
	...
	ID:   whereHelpertypes_UUID{field: "`users`.`id`"},
...
func (q userQuery) One(ctx context.Context, exec boil.ContextExecutor) (*User, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "most: failed to execute a one query for users")
	}
...
func (q userQuery) All(ctx context.Context, exec boil.ContextExecutor) (UserSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "most: failed to assign all query results to User slice")
	}
...
func (q userQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "most: failed to count users rows")
	}
...
func (q userQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "most: failed to check if users exists")
	}
...
func (o *User) Roles(mods ...qm.QueryMod) roleQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("`users_roles` on `roles`.`id` = `users_roles`.`roles_id`"),
		qm.Where("`users_roles`.`users_id`=?", o.ID),
	)
...
func (userL) LoadOrders(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`orders`), qm.WhereIn(`users_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.ID, foreign.UsersID) {
...
func (userL) LoadRoles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("`roles`.*, `a`.`users_id`"),
		qm.From("`roles`"),
		qm.InnerJoin("`users_roles` as `a` on `roles`.`id` = `a`.`roles_id`"),
		qm.WhereIn("`a`.`users_id` in ?", args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddOrders(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Order) error {
	...
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.UsersID, o.ID)
...
func (o *User) SetOrders(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Order) error {
	query := "update `orders` set `users_id` = null where `users_id` = ?"
	...
	if o.R != nil {
		for _, rel := range o.R.Orders {
			queries.SetScanner(&rel.UsersID, nil)
			if rel.R == nil {
				continue
			}
...
func (o *User) RemoveOrders(ctx context.Context, exec boil.ContextExecutor, related ...*Order) error {
	...
	for _, rel := range related {
		...
		if _, err = rel.Update(ctx, exec, boil.Whitelist("users_id")); err != nil {
			return err
		}
	}
	if o.R == nil {
...
func (o *User) AddRoles(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Role) error {
	...
	for _, rel := range related {
		query := "insert into `users_roles` (`users_id`, `roles_id`) values (?, ?)"
		values := []interface{}{o.ID, rel.ID}
...
func (o *User) SetRoles(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Role) error {
	query := "delete from `users_roles` where `users_id` = ?"
	values := []interface{}{o.ID}
	if boil.DebugMode {
		fmt.Fprintln(boil.DebugWriter, query)
		fmt.Fprintln(boil.DebugWriter, values)
...
func (o *User) RemoveRoles(ctx context.Context, exec boil.ContextExecutor, related ...*Role) error {
	var err error
	query := fmt.Sprintf(
		"delete from `users_roles` where `users_id` = ? and `roles_id` in (%s)",
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD types.UUID, selectCols ...string) (*User, error) {
	userObj := &User{}
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "most: unable to select from users")
	}
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("most: no users provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "most: unable to insert into users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "most: unable to populate default values for users")
	}
...
func (o *User) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("most: unable to update users, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "most: unable to update users row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "most: failed to get rows affected by update for users")
	}
...
func (q userQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "most: unable to update all for users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "most: unable to retrieve rows affected for users")
	}
...
func (o UserSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "most: unable to update all in user slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "most: unable to retrieve rows affected all in update all user")
	}
	return rowsAff, nil
}
...
func (o *User) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("most: no users provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("most: unable to upsert users, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "most: unable to upsert for users")
	}
	...
	if err != nil {
		return errors.Wrap(err, "most: unable to retrieve unique values for users")
	}
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("most: no User provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "most: unable to delete from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "most: failed to get rows affected by delete for users")
	}
...
func (q userQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("most: no userQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "most: unable to delete all from users")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "most: failed to get rows affected by deleteall for users")
	}
...
func (o UserSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "most: unable to delete all from user slice")
	}
...
func (o *UserSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "most: unable to reload all in UserSlice")
	}
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD types.UUID) (bool, error) {
	var exists bool
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "most: unable to check if users exists")
	}
