...
func testOrderToOneUserUsingUser(t *testing.T) {
	...
	queries.Assign(&local.UsersID, foreign.ID)
...
func testOrderToOneSetOpUserUsingUser(t *testing.T) {
	...
	for i, x := range []*User{&b, &c} {
		...
		if !queries.Equal(a.UsersID, x.ID) {
...
func testOrderToOneRemoveOpUserUsingUser(t *testing.T) {
	...
	if !queries.IsValuerNil(a.UsersID) {
...
var (
	orderDBTypes = map[string]string{`ID`: `binary`, `Name`: `varchar`, `UsersID`: `binary`}
	_            = bytes.MinRead
)
