...
func main() {
	...
	// Если запустить этот код с ключом race, можно заметить, что мы никак не гарантируем завершение всех работ
	// Для того, чтобы гарантии были, стоит использовать WaitGroup
