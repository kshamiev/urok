...
type Role struct {
	...
	Code        string `db:"code" pg:"code,use_zero" boil:"code" json:"code"`
	Description string `db:"description" pg:"description,use_zero" boil:"description" json:"description"`

	R *roleR `db:"-" pg:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
	L roleL  `db:"-" pg:"-" boil:"-" json:"-" toml:"-" yaml:"-"`
}
...
type roleR struct {
	Users UserSlice `db:"Users" pg:"Users" boil:"Users" json:"Users" toml:"Users" yaml:"Users"`
}
...
var (
	roleAllColumns            = []string{"id", "code", "description"}
	roleColumnsWithoutDefault = []string{"code", "description"}
...
func (q roleQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Role, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "tp: failed to execute a one query for roles")
	}
...
func (q roleQuery) All(ctx context.Context, exec boil.ContextExecutor) (RoleSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "tp: failed to assign all query results to Role slice")
	}
...
func (q roleQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "tp: failed to count roles rows")
	}
...
func (q roleQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "tp: failed to check if roles exists")
	}
...
func (o *Role) Users(mods ...qm.QueryMod) userQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"users_roles\" on \"users\".\"id\" = \"users_roles\".\"user_id\""),
		qm.Where("\"users_roles\".\"role_id\"=?", o.ID),
	)
...
func (roleL) LoadUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.Select("\"users\".\"id\", \"users\".\"login\", \"users\".\"description\", \"users\".\"price\", \"users\".\"summa_one\", \"users\".\"summa_two\", \"users\".\"cnt\", \"users\".\"cnt4\", \"users\".\"cnt8\", \"users\".\"sharding_id\", \"users\".\"is_online\", \"users\".\"json_struct_null\", \"users\".\"json_struct\", \"users\".\"json_string_null\", \"users\".\"json_string\", \"users\".\"role_custom\", \"users\".\"duration\", \"users\".\"data\", \"users\".\"alias\", \"users\".\"created_at\", \"users\".\"updated_at\", \"users\".\"deleted_at\", \"users\".\"inn\", \"users\".\"kpp\", \"users\".\"grpc\", \"users\".\"ogrn\", \"users\".\"ekk\", \"users\".\"guid\", \"a\".\"role_id\""),
		qm.From("\"users\""),
	...
	for results.Next() {
		...
		err = results.Scan(&one.ID, &one.Login, &one.Description, &one.Price, &one.SummaOne, &one.SummaTwo, &one.Cnt, &one.Cnt4, &one.Cnt8, &one.ShardingID, &one.IsOnline, &one.JsonStructNull, &one.JsonStruct, &one.JsonStringNull, &one.JsonString, &one.RoleCustom, &one.Duration, &one.Data, &one.Alias, &one.CreatedAt, &one.UpdatedAt, &one.DeletedAt, &one.Inn, &one.Kpp, &one.Grpc, &one.Ogrn, &one.Ekk, &one.Guid, &localJoinCol)
		if err != nil {
...
func (o *Role) AddUsers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*User) error {
	...
	for _, rel := range related {
		query := "insert into \"users_roles\" (\"role_id\", \"user_id\") values ($1, $2)"
...
func (o *Role) SetUsers(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*User) error {
	query := "delete from \"users_roles\" where \"role_id\" = $1"
...
func (o *Role) RemoveUsers(ctx context.Context, exec boil.ContextExecutor, related ...*User) error {
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"users_roles\" where \"role_id\" = $1 and \"user_id\" in (%s)",
...
func FindRole(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Role, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "tp: unable to select from roles")
	}
...
func (o *Role) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("tp: no roles provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "tp: unable to insert into roles")
	}
...
func (o *Role) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("tp: unable to update roles, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "tp: unable to update roles row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "tp: failed to get rows affected by update for roles")
	}
...
func (q roleQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "tp: unable to update all for roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "tp: unable to retrieve rows affected for roles")
	}
...
func (o RoleSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "tp: unable to update all in role slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "tp: unable to retrieve rows affected all in update all role")
	}
	return rowsAff, nil
}
...
func (o *Role) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("tp: no roles provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("tp: unable to upsert roles, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "tp: unable to upsert roles")
	}
...
func (o *Role) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("tp: no Role provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "tp: unable to delete from roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "tp: failed to get rows affected by delete for roles")
	}
...
func (q roleQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("tp: no roleQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "tp: unable to delete all from roles")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "tp: failed to get rows affected by deleteall for roles")
	}
...
func (o RoleSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "tp: unable to delete all from role slice")
	}
...
func (o *RoleSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "tp: unable to reload all in RoleSlice")
	}
...
func RoleExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "tp: unable to check if roles exists")
	}
