// Стратегия
// Тип реализующие данный паттерн определяет какой функционал использовать для решения задачи.
//
// к примеру с его помощью можно подставлять нужную формулу для расчета
package main
