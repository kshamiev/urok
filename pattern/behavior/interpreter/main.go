// Интерпретатор
// Структура реализующая интерфейс с использованием другой (альтернативной) реализацией этого же интерфейса.
// (Другая интерпретация интерфейса)

// Практическое применение
// Когда нужно сделать анализ изсходя из результатов нескольких интерпретаций
package main
