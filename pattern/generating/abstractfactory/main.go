// Абстрактная фабрика
// Абстрактная фабрика это интерфейс с методами создания абстрактных типов
// Тип реализующий данный интерфейс это конкретная фабрика
// Задача фабрики создавать конкретные типы - модели удовлетворяющие интерфейс
// И скрывать в себе алгоритм и условия их создания
package main
