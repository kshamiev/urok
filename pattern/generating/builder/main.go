// Строитель
// По сути сценарист - прораб
// Принимает тип реализующий определенный интерфейс
// И выполняет набор (сценарий его методов) методов вкладывая определенный набор данных
// Хороший пример соединения данных с поведением
package main
