...
// Принимает тип реализующий определенный интерфейс - сценарий
// И выпоняет все его методы вкладывая определенный набор данных
// Хороший пример соединения данных с поведеинем
package main
